...
public class CreateQuotePage extends SeleniumUtility{
	...
	public WebElement getQuoteSubjectTxt()
	{
	...
	public WebElement getQuoteStageTxt()
	{
		return quoteStageTxt;
	}
	...
	//Business Library for create quote
	
	/**
	 * This method will perform create quote operation
	 * @param driver
	 * @param qSubject
	 * @param vTill
	 * @param qStage
	...
	public void createQuote(WebDriver driver,String qSubject,String vTill,String qStage,String bAdd,String bPO,String bCity,String bState,String bpCode,String bCountry,String sAdd,
			String sPO,String sCity,String sState,String spCode,String sCountry,String opportunity,String contact,String product) throws InterruptedException
	{
		quoteSubjectTxt.sendKeys(qSubject);
		validTillTxt.sendKeys(vTill);
		quoteStageTxt.sendKeys(qStage);
